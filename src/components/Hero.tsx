  ...
  return (
    <section className="relative min-h-[100svh] bg-[#E7EFDA] overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 lg:px-12 flex flex-col justify-start md:justify-center min-h-[100svh]">
        <div className="max-w-[44%] md:max-w-xl pt-28 md:pt-24 pb-12">
          <h1
          ...
          <div className="fade-up delay-2 flex flex-col md:flex-row gap-2 md:gap-3">
            <a
              href="#about"
              className="text-[9px] md:text-xs tracking-widest uppercase bg-[#2C5F4A] text-white px-4 md:px-6 py-2.5 md:py-3.5 hover:bg-[#B8963E] transition-colors font-semibold rounded-lg text-center"
            >
              Learn More
            </a>
            <a
              href="#contact"
              className="text-[9px] md:text-xs tracking-widest uppercase border border-[#2C5F4A] text-[#2C5F4A] px-4 md:px-6 py-2.5 md:py-3.5 hover:bg-[#2C5F4A] hover:text-white transition-colors rounded-lg text-center"
            >
              Get In Touch
            </a>
          </div>
